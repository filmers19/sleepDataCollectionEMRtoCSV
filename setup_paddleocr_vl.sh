...
ENV_DIR="${ENV_DIR:-${ROOT_DIR}/.conda_envs/paddleocr_vl}"
...
python -m pip install --upgrade -r "${ROOT_DIR}/requirements_paddleocr_vl.txt"

echo ""
echo "PaddleOCR-VL environment is ready."
echo "Python: ${ENV_DIR}/bin/python"
echo "Activate with: conda activate ${ENV_DIR}"
echo "Test with: ${ENV_DIR}/bin/python ${ROOT_DIR}/108_ocr_only_patient_local_qwen.py --model_id PaddlePaddle/PaddleOCR-VL-1.5 --patient_name Patient_10"
